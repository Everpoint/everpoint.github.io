define(["require", "exports", "./utils"], function (require, exports, utils_1) {
    ...
    class Color {
         ...
         * @returns {Boolean}
         */
        get isValid() { return utils_1.isNumber(this._channels.a) && utils_1.isNumber(this._channels.r) && utils_1.isNumber(this._channels.g) && utils_1.isNumber(this._channels.b); }
        /**
