define(["require", "exports"], function (require, exports) {
     ...
     */
    exports.listenDomEvent = function (element, type, handler) {
        if (type === 'wheel')
            type = getWheelEventType();
        if (!handler.guid)
            handler.guid = ++id;
        if (!element.events) {
            element.events = {};
     ...
     */
    exports.removeDomEventListener = function (element, type, handler) {
     ...
     * @returns {number}
     */
    exports.getWheelDirection = function (e) {
     ...
     */
    exports.getMouseOffset = function (target, e) {
        let docPos = target === document || target === window ? { x: 0, y: 0 } : exports.getPosition(target);
    ...
    exports.getPosition = function (e) {
        var clientRect = e.getBoundingClientRect(), x = (window.pageXOffset !== undefined) ? window.pageXOffset : (document.documentElement || document.body.parentNode || document.body).scrollLeft, y = (window.pageYOffset !== undefined) ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
