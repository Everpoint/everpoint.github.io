...
`;
    ...
    class ClusterSymbol extends Symbol_1.DynamicPointSymbol {
        constructor({ font = '13px Times New Roman, sans-serif', outlineWidth = 2, size = 44, fillColor = '#fff', fontColor = '#000', borderWidth = 6, borderColor = '#89CCF1', offset = [-size / 2, -size / 2], } = {}) {
            super({ offset });
            this.font = font;
            this.size = size;
