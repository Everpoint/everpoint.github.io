...
`;
    ...
    class ClusterSymbol extends Symbol_1.DynamicPointSymbol {
        constructor({ node, count, wrapperClassNames = '', svgClassNames = '', labelClassNames = '', strokeWidth = 6, size = 44 - strokeWidth, values = [], offset = [-size / 2, -size / 2], colors = [], fill = '#fff', stroke = '#89CCF1', } = {}) {
            super({ offset });
