...
/// Title: "Point symbols"
define(["require", "exports", "../../../source/layers/FeatureLayer", "../../../source/features/PointFeature", "../../../source/init", "../../../source/symbols/point/Point", "../../../source/symbols/point/Square", "../../../source/symbols/point/StaticImageSymbol", "../../../source/symbols/point/MaskedImage", "../../../source/layers/TileLayer", "../../../source/symbols/point/CrossPointSymbol", "../../../source/symbols/point/DynamicImageSymbol"], function (require, exports, FeatureLayer_1, PointFeature_1, init_1, Point_1, Square_1, StaticImageSymbol_1, MaskedImage_1, TileLayer_1, CrossPointSymbol_1, DynamicImageSymbol_1) {
    "use strict";
    ...
    let symbols = [
        new Point_1.PointSymbol(),
        new Point_1.PointSymbol({ size: 30, strokeColor: 'green', strokeWidth: 2, fillColor: 'rgba(0,255,0,0.5)' }),
    ...
    symbols.forEach(symbol => {
        features.push(new PointFeature_1.PointFeature(position, { symbol: crossSymbol, crs: map.crs }));
        features.push(new PointFeature_1.PointFeature(position, { symbol, crs: map.crs }));
