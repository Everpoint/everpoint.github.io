...
define(["require", "exports", "../../../source/init", "../../../source/layers/TileLayer", "../../../source/layers/FeatureLayer", "../../../source/features/Point", "../../../source/controls/BalloonControl", "../../../source/Point"], function (require, exports, init_1, TileLayer_1, FeatureLayer_1, Point_1, BalloonControl_1, Point_2) {
    "use strict";
    ...
    let { map, painter } = init_1.init({
        ...
        centerPoint: new Point_2.Point([57.84, 40.56]),
    ...
    points.forEach(point => {
        let feature = new Point_1.PointFeature(point.position);
